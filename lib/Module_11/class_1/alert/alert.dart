          ...
          children: [
            ...
            ElevatedButton(onPressed: (){
              showAlertDialog();
                ...
                'Alert Dialog',style: TextStyle(color: Colors.blue),
            )),

            ElevatedButton(onPressed: (){
              showAlertDialogWithIcon();
            }, child: Text(
                'Alert Dialog with icon',style: TextStyle(color: Colors.blue),
            )),

            ElevatedButton(onPressed: (){
              showSimpleDialog();
            }, child: Text(
                'Simple Dialog',style: TextStyle(color:Colors.blue ),
            )),

            ElevatedButton(onPressed: (){
              showBottomSheetAlert();
            }, child: Text(
                'Bottom sheet',style: TextStyle(color: Colors.blue),
            )),
